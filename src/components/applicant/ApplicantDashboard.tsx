          ...
          <div className="bg-white rounded-2xl shadow-xs border border-zinc-200 overflow-hidden">
            ...
            <div className="p-6 sm:p-8 space-y-6">
              ...
              <div className="mt-8 pt-6 border-t border-zinc-100 flex items-center justify-between">
                <span className="text-xs text-zinc-500 font-medium">Submitted Application Record</span>
                <button
                  type="button"
                  onClick={() => setShowViewFormModal(true)}
                  className="px-4 py-2 rounded-xl text-xs font-semibold text-orange-600 bg-orange-50 hover:bg-orange-100 transition cursor-pointer flex items-center space-x-1.5"
                >
                  <FileText className="w-3.5 h-3.5" />
                  <span>View Submitted Application Form</span>
                </button>
