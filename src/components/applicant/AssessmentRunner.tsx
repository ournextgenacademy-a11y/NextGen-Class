  ...
  if (completedResult) {
    return (
      <div className="max-w-3xl mx-auto bg-white rounded-3xl shadow-xl border border-slate-200 p-6 sm:p-10 text-center animate-in fade-in space-y-6">
        ...
        {/* Big Score Card */}
        <div className="bg-gradient-to-br from-slate-50 to-indigo-50/40 border border-slate-200 rounded-3xl p-6 max-w-lg mx-auto space-y-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          <button
            type="button"
            onClick={onComplete}
            className="w-full sm:w-auto inline-flex items-center justify-center space-x-2 bg-indigo-600 hover:bg-indigo-700 text-white font-bold px-8 py-3 rounded-2xl text-xs shadow-md transition cursor-pointer"
          >
    ...
    return (
      <div className="max-w-3xl mx-auto bg-white rounded-3xl shadow-xl border border-slate-200 p-6 sm:p-10 space-y-8 animate-in fade-in">
        ...
        <div className="space-y-2">
          <div className="flex items-center space-x-2">
            <span className="text-xs font-bold text-indigo-600 bg-indigo-50 px-3 py-1 rounded-full border border-indigo-100 uppercase tracking-wider">
              ...
              {resources.map(res => (
                <div key={res.id} className="bg-slate-50 p-3 rounded-xl border border-slate-200 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="p-1.5 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-lg text-xs font-semibold shrink-0 cursor-pointer"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-4 border-t border-slate-100">
          ...
          <button
            ...
            className="w-full sm:w-auto flex items-center justify-center space-x-2 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed text-white text-xs font-bold px-8 py-3.5 rounded-xl shadow-md transition cursor-pointer"
          >
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-4 sm:p-5 flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2.5">
          ...
          <div className="text-[11px] text-slate-500 flex items-center space-x-1 bg-slate-50 px-2.5 py-1 rounded-lg border border-slate-200">
            {isAutoSaving ? (
              <span className="text-indigo-600 font-semibold animate-pulse">Saving...</span>
            ) : (
              <>
          ...
          {resources.length > 0 && (
            <button
              ...
              className="flex items-center space-x-1.5 px-3 py-1.5 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-bold text-xs rounded-xl border border-indigo-200 transition cursor-pointer"
            >
      ...
      {showResourcesDrawer && resources.length > 0 && (
        <div className="bg-indigo-50/70 border border-indigo-200 rounded-2xl p-5 space-y-3 animate-in fade-in">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2.5 pt-1">
            {resources.map(res => (
              <div
                key={res.id}
                className="bg-white rounded-xl p-3 border border-indigo-100 shadow-2xs flex items-center justify-between space-x-2"
              >
                <div className="truncate">
        ...
        {currentQ ? (
          <div className="lg:col-span-8 bg-white rounded-2xl shadow-sm border border-slate-200 p-6 sm:p-8 space-y-6 lg:order-2 order-1">
            ...
            <div className="flex flex-wrap items-center justify-between text-xs pb-4 border-b border-slate-100 gap-2">
              <div className="flex items-center space-x-2">
                <span className="bg-indigo-50 text-indigo-700 font-bold px-2.5 py-1 rounded-full border border-indigo-100">
              ...
              {currentQ.type === 'short_answer' && (
                <div>
                  <input
                    ...
                    className="w-full text-xs p-3.5 rounded-xl border border-slate-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition font-medium"
                  />
              ...
              {(currentQ.type === 'long_answer' || currentQ.type === 'open_text') && (
                <div>
                  <textarea
                    ...
                    className="w-full text-xs p-3.5 rounded-xl border border-slate-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 outline-none transition resize-y"
                  />
            ...
            <div className="pt-6 border-t border-slate-100 flex items-center justify-between">
              ...
              {currentIndex < totalQuestions - 1 ? (
                <button
                  ...
                  className="flex items-center space-x-1 bg-indigo-600 hover:bg-indigo-700 text-white px-5 py-2.5 rounded-xl text-xs font-bold shadow-sm transition cursor-pointer"
                >
