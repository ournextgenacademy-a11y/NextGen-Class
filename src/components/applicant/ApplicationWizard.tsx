            ...
            return (
              <button
                ...
                className={`flex items-center justify-between p-3.5 rounded-xl text-left transition ${
                  isCurrent
                    ? 'bg-indigo-50/90 border-2 border-indigo-600 ring-2 ring-indigo-600/10'
                    : isPassed
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-[11px] text-slate-500">
                      ...
                      <span className="font-semibold text-indigo-600">{cohCount} Open Cohort{cohCount !== 1 ? 's' : ''}</span>
                    </div>
                  </div>
                );
              })}
        ...
        {currentStep === 2 && (
          <div className="p-6 space-y-6">
            ...
            <div className="p-4 rounded-xl bg-indigo-50/70 border border-indigo-100 space-y-2 mt-4">
              <div className="flex items-start space-x-2 text-xs text-indigo-950 font-medium">
          ...
          <div className="flex items-center space-x-2">
            ...
            {currentStep < 2 ? (
              <button
                ...
                className="inline-flex items-center space-x-1.5 px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-xs font-bold text-white shadow-xs transition cursor-pointer"
              >
