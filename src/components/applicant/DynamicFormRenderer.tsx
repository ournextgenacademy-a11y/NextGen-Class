                ...
                <input
                  ...
                  className={`w-full text-xs p-3 rounded-xl border transition outline-none ${
                    hasError
                      ...
                      : 'border-slate-300 bg-white focus:border-orange-500 focus:ring-1 focus:ring-orange-500'
                  ...
                  return (
                    <label
                      ...
                      className={`flex items-center space-x-3 p-3 rounded-xl border text-xs transition cursor-pointer ${
                        isSelected
                          ? 'border-orange-500 bg-orange-50/60 font-semibold text-zinc-950 shadow-xs'
                  ...
                  field.options.map((opt) => {
                    ...
                    return (
                      <label
                        ...
                        className={`flex items-center space-x-3 p-3 rounded-xl border text-xs transition cursor-pointer ${
                          isChecked
                            ? 'border-orange-500 bg-orange-50/50 font-semibold text-zinc-950 shadow-xs'
                            : 'border-slate-200 bg-white hover:bg-slate-50 text-slate-700'
                        } ${disabled ? 'cursor-not-allowed opacity-70' : ''}`}
                      >
                        <input
                          ...
                          className="text-orange-600 focus:ring-orange-500 rounded h-4 w-4"
                        />
                        <span>{opt}</span>
                      </label>
                    );
                  ...
                  return (
                    <div
                      ...
                      className={`flex items-center justify-between p-3 rounded-xl border text-xs transition cursor-pointer select-none ${
                        isSelected
                          ? 'border-orange-500 bg-orange-50 text-zinc-950 font-semibold shadow-xs ring-1 ring-orange-500/30'
                          : 'border-slate-200 bg-white hover:border-slate-300 text-slate-700'
                      } ${disabled ? 'cursor-not-allowed opacity-70' : ''}`}
                    >
                      <span>{opt}</span>
                      <div className={`w-5 h-5 rounded-md flex items-center justify-center border transition ${
                        isSelected ? 'bg-orange-500 border-orange-500 text-white' : 'border-slate-300 bg-slate-50'
                      }`}>
